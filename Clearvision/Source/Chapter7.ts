    ...
    export async function Chapter7(): ƒS.SceneReturn {
      ...
      let text = {
        ...
        protagonist: {
          ...
          P0010: "Hey " + characters.girl1.name + " how are you so uninterrested by this?",
          P0011: "Ok gacha.",
          ...
          P2011: "*I can only hear the faint voices of " + characters.girl1.name + " and a doctor before I lose conciousness...*",
